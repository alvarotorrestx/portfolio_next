const projects = [
  ...
  },
  {
    id: "pulsedesk",
    title: "PulseDesk",
    summary: "AI-powered call intelligence platform that analyzes call center conversations using audio and transcript processing to detect sentiment, compliance risk, and coaching opportunities.",
    description: "PulseDesk is an AI-powered call intelligence platform designed to analyze call center conversations and surface operational insights automatically. The platform processes call audio and transcripts through a machine learning pipeline that detects sentiment, identifies conversation intent, highlights compliance risks, and flags key moments within calls. These insights are presented through an interactive dashboard where supervisors can review alerts, analyze transcripts, and monitor agent performance trends. PulseDesk was built as a full-stack application using React and TypeScript for the frontend and a Python FastAPI backend that powers the AI processing pipeline and real-time alerting system.",
